...
$config['amacube_db_dsn'] = 'mysql://amavis:secret@localhost/amavis';
...
$config['amacube_amavis_host'] = 'localhost';
$config['amacube_amavis_port'] = '9998';
...
$config['amacube_auto_create_user'] = true;
